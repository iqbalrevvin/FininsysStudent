		...
		<tr>
			...
			<td class="td-action">
				<ul class='tools list-unstyled table-menu'>				
					...
					<li id="menu-menu" >
						<a href="<?php echo $action_url; ?>" class="<?php echo $action->css_class; ?> crud-action" title="<?php echo $action->label?>"><i class="<?php echo $action->image_url ?> navigation"></i> <?php echo $action->label; ?></a>	
					</li>
					<?php }	} ?>					

                    <?php if(!$unset_read){?>
                    <li>
						<a href='<?php echo $row->read_url?>' title='<?php echo $this->l('list_view')?> <?php echo $subject?>' class="edit_button navigation"><i class='fa fa-list'></i> Detail</a>   
					</li>
					<?php }?>
					...
					<li>
						<a href='<?php echo $row->edit_url?>' title='<?php echo $this->l('list_edit')?> <?php echo $subject?>' 
							class="edit_button text-success navigation"><i class='fa fa-edit'></i> 
							Edit
						</a> 
					</li>
					<?php }?>
